import { l as mime, c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, s as spreadAttributes, b as addAttribute, f as renderComponent, F as Fragment } from '../astro.f5b2d3c4.mjs';
...
async function getImage(transform) {
  ...
  if (!loader) {
    const { default: mod } = await import('./endpoint.js.6276cce4.mjs').then(n => n.s).catch(() => {
      throw new Error(
...
}, "/Users/fullsnack/Documents/play/bun/ogm/node_modules/.pnpm/@astrojs+image@0.17.2_astro@2.9.7_sharp@0.32.5/node_modules/@astrojs/image/components/Image.astro", void 0);
...
}, "/Users/fullsnack/Documents/play/bun/ogm/node_modules/.pnpm/@astrojs+image@0.17.2_astro@2.9.7_sharp@0.32.5/node_modules/@astrojs/image/components/Picture.astro", void 0);
    ...
    ${maybeRenderHead()}<main class="mt-16">
      <ul class="grid gap-16 max-w-4xl mx-auto">
        ${publishedBlogEntries.map((blogPostEntry, index) => renderTemplate`<li>
              <a${addAttribute(`/user/${blogPostEntry.slug}`, "href")}>
