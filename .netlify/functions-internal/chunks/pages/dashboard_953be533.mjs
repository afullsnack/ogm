/* empty css                           */import { e as createAstro, f as createComponent, r as renderTemplate, m as maybeRenderHead, i as renderComponent, g as addAttribute, h as renderSlot, k as renderHead } from '../astro_cb3aa52d.mjs';
import 'clsx';
import { jsxs, jsx } from 'react/jsx-runtime';
import { useState, useEffect, createElement, createContext, useContext } from 'react';
import { c as $$DropdownItems, d as $$Dropdown, b as $$Icon } from './404_3d16713a.mjs';
...
const $$Modal = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="w-10 h-10 bg-transparent mx-2 hover:cursor-pointer hover:bg-slate-500/60 transition-all duration-75 border border-slate-300/60 rounded-md flex items-center justify-center justify-items-center p-1"${addAttribute(`window.${id}.showModal()`, "onclick")} data-astro-cid-32rssrx7>${renderComponent($$result, "Icon", $$Icon, { "name": "bi:plus-lg", "class": "w-5 h-5 text-white", "data-astro-cid-32rssrx7": true })}</div><!-- <button >{open}</button> --><dialog${addAttribute(id, "id")} data-astro-cid-32rssrx7>${renderSlot($$result, $$slots["main"])}<form method="dialog" data-astro-cid-32rssrx7>${renderSlot($$result, $$slots["close"])}</form></dialog>`;
...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Header;
  return renderTemplate`${maybeRenderHead()}<div class="sticky top-0 left-0 right-0 h-20 bg-slate-900/80 flex items-center justify-between">${renderComponent($$result, "TabsList", TabsList, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/fullsnack/Documents/play/bun/ogm/src/components/header/TabsLIst", "client:component-export": "default" })}${renderComponent($$result, "Modal", $$Modal, { "id": "newtabmodal", "open": "Open modal" }, { "close": ($$result2) => renderTemplate`<button class="mx-auto text-center absolute right-0 top-1">${renderComponent($$result2, "Icon", $$Icon, { "name": "mdi:window-close", "class": "h-10 w-10 text-slate-300" })}</button>`, "main": ($$result2) => renderTemplate`<main class="w-full grid items-start justify-items-start justify-center min-w-fit overflow-hidden h-full relative">${renderComponent($$result2, "AssetSearch", null, { "client:only": true, "client:component-hydration": "only", "client:component-path": "/Users/fullsnack/Documents/play/bun/ogm/src/components/header/AssetSearch", "client:component-export": "default" })}</main>` })}<div class="w-full grid items-center justify-end px-10">${renderComponent($$result, "AccountNavDropDown", $$AccountNav, { "title": "Practice account", "children": [
    {
      path: "/test",
      title: "Test"
    },
  ...
  ].length - 1 })}<!-- <span class="font-medium text-xs uppercase text-orange-500">
      PRACTISE ACCOUNT
    </span>
    <span class="text-white font-medium text-lg">10,000.00</span> --></div><div class="px-5">${renderComponent($$result, "Icon", $$Icon, { "name": "ic:sharp-notifications", "class": "w-8 h-8 text-white" })}</div></div>`;
...
const $$DashboardLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a$1 || (_a$1 = __template$1(['<html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="generator"', ">", '</head><body class="grid w-screen h-screen bg-slate-800">', '<div class="flex items-start justify-items-start justify-start w-screen overflow-hidden h-calc">', '<div class="w-full overflow-y-scroll grid h-calc">', '</div></div><div class="w-full h-6 bg-blue-500 sticky bottom-0 right-0 left-0 flex items-center justify-end px-5 z-[100]"><span class="text-xs text-white h-full px-2 flex items-center justify-center bg-slate-400/60 hover:bg-slate-400/40 hover:cursor-pointer">', "\nCONTACT US\n</span>", '</div><!-- Tidio chat code --><script src="//code.tidio.co/iq2qipotps6urp8h4c4yzwhytrpdoxia.js" async><\/script></body></html>'])), addAttribute(Astro2.generator, "content"), renderHead(), renderComponent($$result, "Header", $$Header, {}), renderComponent($$result, "Sider", Sider, { "client:load": true, "client:component-hydration": "load", "client:component-path": "@components/sider/sider.tsx", "client:component-export": "default" }), renderSlot($$result, $$slots["default"]), renderComponent($$result, "Icon", $$Icon, { "name": "bi:chat", "class": "w-3 h-3 mr-2" }), renderComponent($$result, "FooterTimer", FooterTimer, { "client:load": true, "client:component-hydration": "load", "client:component-path": "@components/FooterTimer", "client:component-export": "default" }));
...
const $$Dashboard = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "DashboardLayout", $$DashboardLayout, {}, { "default": ($$result2) => renderTemplate(_a || (_a = __template(["", '<div class="grid w-full h-full p-2"><!-- TradingView Widget BEGIN --><div class="tradingview-widget-container h-full"><div id="tradingview_bb32a h-full"></div><!-- <div class="tradingview-widget-copyright">\n        <a\n          href="https://www.tradingview.com/"\n          rel="noopener nofollow"\n          target="_blank"\n          ><span class="blue-text">Track all markets on TradingView</span></a>\n      </div> --><script type="text/javascript" src="https://s3.tradingview.com/tv.js"><\/script><script type="text/javascript">\n        new TradingView.widget({\n          autosize: true,\n          symbol: "BINANCE:BTCUSD",\n          interval: "D",\n          timezone: "Etc/UTC",\n          theme: "dark",\n          style: "1",\n          locale: "en",\n          enable_publishing: false,\n          withdateranges: true,\n          allow_symbol_change: true,\n          container_id: "tradingview_bb32a",\n        });\n      <\/script></div><!-- TradingView Widget END --></div>'])), maybeRenderHead()) })}`;
