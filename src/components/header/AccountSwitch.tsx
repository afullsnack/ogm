    ...
    <div className="px-3 lg:py-2 bg-slate-900 rounded-md shadow border flex gap-5 w-full justify-between border-r border-gray-300 z-50">
      <div className="text-white grid items-start justify-start">
        ...
        <a
          ...
          }/user/withdraw?account=${accountType}`}
          className="grid px-2 py-1 items-start justify-items-start justify-center gap-1 text-gray-300 hover:text-gray-600 bg-gray-700/50 hover:bg-slate-400/20 active:bg-slate-400/30">
          <span>{"WITHDRAW"}</span>
        </a>
      </div>
